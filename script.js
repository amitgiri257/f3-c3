...
function getCurrentImageOfTheDay() {
    ...
    const apiKey = 'vX9jafSqfX9DFIYNTJGoGEHWoTYXK2J0ejz4eP9c';
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=${apiKey}&date=${currentDate}`)
        ...
        .then(data => {
            ...
            currentImageContainer.innerHTML = `
                ...
                <img id="img1 src="${data.url}" alt="${data.title}">
                <h2>${data.title}</h2>
...
function getImageOfTheDay(date) {
    const apiKey = 'vX9jafSqfX9DFIYNTJGoGEHWoTYXK2J0ejz4eP9c'; // Replace with your NASA API key
